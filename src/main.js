...
const apiService = new BigTripApiService('https://24.objects.htmlacademy.pro/big-trip', 'Basic a8f7k1p9x4');
...
const tripInfoPresenter = new TripInfoPresenter({container: tripMainElement, pointsModel});
